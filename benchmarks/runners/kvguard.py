"""KVGuard active policy benchmark runner."""
...
async def run_kvguard_benchmark(
    workload_type: str = "mixed", num_requests: int = 50
) -> BenchmarkMetrics:
    """Execute KVGuard-managed workload simulating proactive retention, CPU offload, and prefetching."""
