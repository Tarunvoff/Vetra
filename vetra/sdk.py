"""Public Python SDK for integrating Vetra into inference applications."""

from __future__ import annotations

import asyncio
from typing import Any, Dict, List, Optional
from vetra.api.dependencies import ServiceContainer
from vetra.config import Settings, load_settings
from vetra.core.enums import EngineType, ExecutionMode
from vetra.core.models import Recommendation
from vetra.api.schemas.stats import StatsOverviewResponse


class Vetra:
    """High-level Python client for controlling Vetra."""
    ...
    async def astart(self) -> None:
        """Asynchronously start Vetra services."""
    ...
    async def astop(self) -> None:
        """Asynchronously stop Vetra services."""
