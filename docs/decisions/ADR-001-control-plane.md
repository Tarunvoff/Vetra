...
## Decision
KVGuard operates strictly as an out-of-process control plane. The inference engine handles raw forward passes and memory allocation; KVGuard monitors telemetry, scores block utility, and issues placement recommendations.
